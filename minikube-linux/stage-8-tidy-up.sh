...
yes_or_no "Would you like to stop the minikube cluster, including TAP?" \
  && minikube stop \
...
yes_or_no "Would you like to delete the Minikube cluster, including TAP?" \
  && minikube delete

# Remove Tanzu CLI
yes_or_quit "Would you like to delete the Tanzu CLI? (needs sudo)?" 
